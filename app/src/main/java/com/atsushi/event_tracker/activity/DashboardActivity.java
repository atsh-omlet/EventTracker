...
public class DashboardActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dashboardViewModel.getShouldReschedule().observe(this, reschedule -> {
            if (Boolean.TRUE.equals(reschedule)) {
                dashboardViewModel.rescheduleNotifications();
                dashboardViewModel.setShouldReschedule(false);
            }
        });
        ...
        if (isPastInitialSetup && !dashboardViewModel.shouldOptOutReminder()) {
            ...
            dashboardViewModel.getShouldShowExactAlarmGrantDialog().observe(this, show -> {
                if (show) {
                    ...
                    dashboardViewModel.setPermissionGranted(true);
                }
            });
        }
        /*
